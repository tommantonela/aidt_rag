...
# Outputs
OUTPUT_RANKINGS = "./data/rankings_experiment4.csv"
OUTPUT_METRICS = "./data/metrics_experiment4.csv"
...
# userstories_df = userstories_df.head(8)
print() 

# Run the RAG for all the queries
list_dfs = []
ignoreLLM = False
filter_cols = ['package_name', 'adjectives', 'description']
